...
public class ImagesContentProvider extends ContentProvider {
    private static String AUTHORITY = "freemahn.com.extratask1.imagesContentProvider";
    public static final Uri IMAGES_URI = Uri.parse("content://" + AUTHORITY + "/" + DatabaseHelper.DATABASE_TABLE);
